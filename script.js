document.addEventListener('DOMContentLoaded', () => {
    const products = {
        'website': [
            { id: 'RC30R-ROS', name: 'Página Web Informativa: Portafolio de 10 imágene + elaboración de la Misión y la Visión de tu negocio', price: 5.99, image: 'assets/images/image1.jpg', tags: ['rojo', 'rosas', 'ligero', 'Rosatel'] },
