document.addEventListener('DOMContentLoaded', () => {
    const products = {
        'website': [
            { id: 'PW', name: "**Tu Página Web Profesional en Sólo 48 Horas** Todo lo que necesitas para tener una web profesional y exitosa Portafolio Visual 10 imágenes personalizadas que muestran lo mejor de tu negocio Misión y Visión Redacción de la misión y visión de tu empresa para transmitir tus valores Dominio cl Exclusivo Tu propio dominio web (www.tunegocio.cl) Hosting Anual Incluido: Alojamiento seguro y confiable durante todo un año ¡Tu página web online en solo 48 horas! Comienza ahora y lleva tu negocio al siguiente nivel ¡Contáctanos hoy mismo!", price: 199.99, image: 'assets/images/Primera.png', tags: ['rojo', 'rosas', 'ligero', 'Rosatel'] },
