document.addEventListener('DOMContentLoaded', () => {
    const products = {
        'website': [
            { id: 'PW',   name: "Tu Página Web Profesional en Sólo 48 Horas Todo lo que necesitas para tener una web profesional y exitosa. <strong>Portafolio Visual</strong> 10 imágenes personalizadas que muestran lo mejor de tu negocio. <strong>Misión y Visión</strong> Redacción de la misión y visión de tu empresa para transmitir tus valores. <strong>Dominio Exclusivo</strong> Tu propio dominio web (www.tunegocio.cl). <strong>Hosting Anual Incluido</strong>: Alojamiento seguro y confiable durante todo un año. ¡Tu página web online en solo 48 horas! Comienza ahora y lleva tu negocio al siguiente nivel. ¡Contáctanos hoy mismo!", price: 199.99, image: 'assets/images/Primera.png', tags: ['rojo', 'rosas', 'ligero', 'Rosatel'] },
